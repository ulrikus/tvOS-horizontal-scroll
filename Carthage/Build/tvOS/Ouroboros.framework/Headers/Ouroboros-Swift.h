...
SWIFT_MODULE_NAMESPACE_PUSH("Ouroboros")
...
SWIFT_CLASS("_TtC9Ouroboros16InfiniteCarousel")
@interface InfiniteCarousel : UICollectionView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@property (nonatomic, readonly, weak) id <UICollectionViewDataSource> _Null_unspecified rootDataSource;
/// The original delegate for the carousel
@property (nonatomic, readonly, weak) id <UICollectionViewDelegateFlowLayout> _Nullable rootDelegate;
...
- (NSIndexPath * _Nonnull)adjustedIndexPathForIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)reloadData;
